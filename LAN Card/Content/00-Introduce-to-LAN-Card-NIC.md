...
![*[ภาพที่ 3] **Network Interface Card ที่ใช้เป็นตัวเชื่อมต่อกับระบบเครือข่าย***](../assets/NIC_Connect.jpg)
...
![*[ภาพที่ 4] **Network Interface Card ในระบบปฏิบัติการของ linux***](../assets/LINUXandNIC.jpg)
